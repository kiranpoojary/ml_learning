...
def load_saved_artifacts():
    ...
    with open("server/artifacts/class_dictionery.json", "r") as f:
...
if __name__ == '__main__':
    ...
    print(classify_image(None, "server/test_image/roger1.jpg"))
    print(classify_image(None, "server/test_image/serena1.jpg"))
